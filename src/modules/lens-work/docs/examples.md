...
**Expected Output:**
`{docs_output_folder}/{domain}/{service}/architecture.md` and related docs.
...
**Expected Output:** `{docs_output_folder}/{domain}/{service}/analysis-summary.md`
...
**Expected Output:**
`{docs_output_folder}/{domain}/{service}/architecture.md`, `api-surface.md`, `data-model.md`, `integration-map.md`, `onboarding.md`
