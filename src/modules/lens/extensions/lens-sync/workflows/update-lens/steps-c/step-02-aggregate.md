...
```yaml
output_paths:
  architecture: "{docs_output_folder}/lens-sync/services/{service}/architecture.md"
  api_surface: "{docs_output_folder}/lens-sync/services/{service}/api-surface.md"
  data_model: "{docs_output_folder}/lens-sync/services/{service}/data-model.md"
  integration_map: "{docs_output_folder}/lens-sync/services/{service}/integration-map.md"
```
