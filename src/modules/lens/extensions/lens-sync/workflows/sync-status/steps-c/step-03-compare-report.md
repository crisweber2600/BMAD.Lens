...
outputFile: '{docs_output_folder}/lens-sync/sync-status-report.md'
---
...
Generate `{docs_output_folder}/lens-sync/sync-status-report.md`:
...
drift_report_path: "{docs_output_folder}/lens-sync/sync-status-report.md"
pending_conflicts:
  - id: string
    path: string
    type: string
...
sync_status:
  ...
  report_path: "{docs_output_folder}/lens-sync/sync-status-report.md"
```
