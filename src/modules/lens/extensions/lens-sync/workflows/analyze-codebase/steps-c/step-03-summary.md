...
outputFile: '{docs_output_folder}/lens-sync/{target}/analysis-summary.md'
---
...
```bash
output_path = "{docs_output_folder}/lens-sync/{target_name}/"
mkdir -p "{output_path}"
...
report_path: "{docs_output_folder}/lens-sync/{target}/analysis-summary.md"
```
...
**File:** `{docs_output_folder}/lens-sync/analysis-batch-{timestamp}.md`
