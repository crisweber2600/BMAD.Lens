...
async function install(options) {
    ...
    try {
        logger.log(chalk.blue('Installing LENS module assets...'));
        ...
        logger.log(chalk.green('✓ LENS module installation complete'));
        return true;
    } catch (error) {
        logger.error(chalk.red(`Error installing LENS module: ${error.message}`));
        return false;
    }
}
