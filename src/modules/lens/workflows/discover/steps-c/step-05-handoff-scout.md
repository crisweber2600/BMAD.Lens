...
### 5. SCOUT Agent Activation

**IF SCOUT agent not available:**
...
The full discovery pipeline requires the SCOUT agent (part of lens module).

Initial discovery is complete. Discovery reports available at:
{project-root}/Docs/{domain}/{service}/

To run the complete pipeline:
1. Activate SCOUT agent manually
2. Run: AUTO command for full automation
