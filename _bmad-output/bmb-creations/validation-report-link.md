...
agentName: 'Link'
agentType: 'module'
agentFile: '/workspaces/BMAD.Lens/_bmad-output/bmb-creations/link/link.agent.yaml'
...
**module:** lens
**hasSidecar:** true
**File:** /workspaces/BMAD.Lens/_bmad-output/bmb-creations/link/link.agent.yaml
...
*PASSING:*
- id present and formatted as `_bmad/agents/link/link.md`
- name present and clear (`Link`)
- title present and descriptive (`Lens Guardian`)
...
*PASSING:*
- Role is clear and aligned with integrity/propagation responsibilities.
- Identity defines character without mixing role or principles.
- Communication style focuses on speech patterns (methodical, structured).
...
- Commands align to Link capabilities.
...
- Sidecar folder exists at `{project-root}/_bmad/_memory/link-sidecar/`.
- `link-state.md` and `instructions.md` are present.
- critical_actions use correct `{project-root}/_bmad/_memory/link-sidecar/` format.
