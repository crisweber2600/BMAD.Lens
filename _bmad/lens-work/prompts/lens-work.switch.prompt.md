```prompt
---
description: Switch active initiative, lens, phase, or lane
---
...
4. If arguments specify what to switch (initiative/lens/phase/lane), go directly to that step
...
- `lane` — Switch lane (small/medium/large)
